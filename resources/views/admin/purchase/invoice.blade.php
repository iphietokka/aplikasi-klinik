     ...
     <section class="invoice" id="printableArea">
      ...
      <div class="row invoice-info">
        ...
        <div class="col-sm-4 invoice-col">
          ...
          <br>
          <b>Order Date:</b> {{date('d F Y', strtotime($data->purchase_date))}}<br>
...
agreed quoted fee noted above.
        ...
        <!-- /.col -->
        <div class="col-xs-6">
          <p class="lead">Date : {{date('d F Y', strtotime($data->purchase_date))}}</p>
          ...
          <div class="table-responsive">
            <table class="table">
              ...
              <tr>
                <th>Due</th>
                <td>{{$transaction->net_total - $transaction->paid}}</td>
              </tr>
              <tr>
                <th>Total:</th>
