     ...
     <form role="form" method="POST" action="{{ route('sales-store')}}" enctype="multipart/form-data">
            ...
            <div class="box-body">
              <div class="row">
                <div class="col-xs-4">
                  <label>Tanggal</label>
                  <input type="text" class="form-control" placeholder="Tanggal Penjualan" name="sales_date" value="{{old('sales_date')}}" id="datepicker">
            ...
            <div class="box-body">
              <table id="purchaseInvoice" class="table table-bordered table-hover">
                ...
                <th width="10%" class="text-center">Stock <small>(in hand)</small></th>
